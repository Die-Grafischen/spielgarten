...
const projectURL = 'spielgarten.local';
...
const textDomain = 'SPIELGARTEN';

// Name of the translation file.
const translationFile = 'SPIELGARTEN.pot';

// Where to save the translation files.
const translationDestination = './languages';

// Package name.
const packageName = 'Spielgarten';

// Where can users report bugs.
const bugReport = 'https://github.com/ivo-ivanov';

// Last translator Email ID.
const lastTranslator = 'Ivo Ivanov';

// Team's Email ID.
const team = 'Ivo Ivanov';
